...
public class SearchActivity extends AppCompatActivity {
    ...
    private final static String KEY = "0f8116f5788740ed81ba5afb446bc2bf";
                    ...
                    if (response != null) {
                        ...
                        if (jsonObject.has(RESPONSE)) {
                            ...
                            if (jsonResponseObject != null) {
                                ...
                                JSONArray jsonDocsArray = jsonResponseObject.getJSONArray(DOCS);
                                List<Article> fetchedArticles = Arrays.asList(gson.fromJson(jsonDocsArray.toString(), Article[].class));
